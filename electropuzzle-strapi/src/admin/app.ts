import favicon from "./extensions/electro-puzzle-logo.png";
...
export default {
  config: {
    ...
    translations: {
      en: {
        // email plugin
        "email.plugin.placeholder.defaultFrom": "ex: ElectroPuzzle No-Reply '<'no-reply@ElectroPuzzle.io'>'",
        "email.plugin.placeholder.defaultReplyTo": "ex: ElectroPuzzle '<'example@ElectroPuzzle.io'>'",
        // "Settings.email.plugin.placeholder.defaultFrom":
        //  "ex: ElectroPuzzle No-Reply <no-reply@ElectroPuzzle.io>",
        // "Settings.email.plugin.placeholder.defaultReplyTo":
        //  "ex: ElectroPuzzle <example@ElectroPuzzle.io>",
        ...
        "Auth.form.button.login.strapi": "Log in via ElectroPuzzle",
        ...
        "Auth.form.register.subtitle":
          "Credentials are only used to authenticate in ElectroPuzzle. All saved data will be stored in your database.",
        "Auth.form.rememberMe.label": "Remember me",
        "Auth.form.username.label": "Username",
        "Auth.form.username.placeholder": "e.g. Kai_Doe",
        "Auth.form.welcome.subtitle": "Log in to your ElectroPuzzle account",
        "Auth.form.welcome.title": "Welcome to ElectroPuzzle!",
        ...
        "HomePage.welcome.congrats.content":
          "You are logged in as the first administrator. To discover the powerful features provided by ElectroPuzzle,",
        ...
        "Settings.application.strapi-version": "ElectroPuzzle version",
        "Settings.application.strapiVersion": "ElectroPuzzle version",
        ...
        "Settings.permissions.users.listview.header.subtitle":
          "All the users who have access to the ElectroPuzzle admin panel",
        ...
        "admin.pages.MarketPlacePage.offline.subtitle":
          "You need to be connected to the Internet to access ElectroPuzzle Market.",
        ...
        "admin.pages.MarketPlacePage.plugin.tooltip.madeByStrapi":
          "Made by ElectroPuzzle",
        "admin.pages.MarketPlacePage.plugin.tooltip.verified":
          "Plugin verified by ElectroPuzzle",
        "admin.pages.MarketPlacePage.plugin.version":
          'Update your ElectroPuzzle version: "{strapiAppVersion}" to: "{versionRange}"',
        "admin.pages.MarketPlacePage.plugin.version.null":
          'Unable to verify compatibility with your ElectroPuzzle version: "{strapiAppVersion}"',
        ...
        "admin.pages.MarketPlacePage.subtitle": "Get more out of ElectroPuzzle",
        "admin.pages.MarketPlacePage.tab-group.label":
          "Plugins and Providers for ElectroPuzzle",
        ...
        "app.components.HomePage.welcomeBlock.content":
          "Congrats! You are logged as the first administrator. To discover the powerful features provided by ElectroPuzzle, we recommend you to create your first Content type!",
        "app.components.HomePage.welcomeBlock.content.again":
          "We hope you are making progress on your project! Feel free to read the latest news about ElectroPuzzle. We are giving our best to improve the product based on your feedback.",
        ...
        "app.components.LeftMenu.navbrand.title": "ElectroPuzzle Dashboard",
        ...
        "app.components.MarketplaceBanner":
          "Discover plugins built by the community, and many more awesome things to kickstart your project, on ElectroPuzzle Marketplace.",
        "app.components.MarketplaceBanner.image.alt": "A ElectroPuzzle rocket logo",
        ...
        "app.components.NpsSurvey.banner-title":
          "How likely are you to recommend ElectroPuzzle to a friend or colleague?",
        ...
        "components.AutoReloadBlocker.description":
          "Run ElectroPuzzle with one of the following commands:",
        ...
        "global.plugins.sentry.description":
          "Send ElectroPuzzle error events to Sentry.",
        ...
        "notification.ee.warning.over-.message":
          "Add seats to {licenseLimitStatus, select, OVER_LIMIT {invite} AT_LIMIT {re-enable}} Users. If you already did it but it's not reflected in ElectroPuzzle yet, make sure to restart your app.",
        ...
        "notification.version.update.message":
          "A new version of ElectroPuzzle is available!",
